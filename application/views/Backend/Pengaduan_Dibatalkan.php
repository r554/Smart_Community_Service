            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-3 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-0">Pengaduan</h2>
                        <p class="mb-0">Data Pengaduan Dibatalkan</p>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $pengaduan['nama_user']; ?></td>
                                            <td><?php echo $pengaduan['lokasi_tkp']; ?></td>
                                            <td><?php echo $pengaduan['keterangan_pengaduan']; ?></td>
                                            <td><span class="btn btn-sm light btn-danger">Pengaduan Ditolak</span></td>
                                            <td>
                                                <div class="dropdown ml-auto text-right">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="<?php echo base_url('Backend/Pengaduan/selesai_pengaduan/' . $pengaduan['id_lapor']) ?>"><i class="las la-check-square scale5 text-primary mr-2"></i>Pengaduan Selesai</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
