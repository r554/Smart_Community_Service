            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-3 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        ...
                        <p class="mb-0">Data Pengaduan Baru</p>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><span class="btn btn-sm light btn-primary">Belum Diproses</span></td>
                                            <td>
                                                <div class="dropdown ml-auto text-right">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="<?php echo base_url('Backend/Pengaduan/terima_pengaduan/' . $pengaduan['id_lapor']) ?>"><i class="las la-check-square scale5 text-primary mr-2"></i>Pengaduan Diterima</a>
                                                        <a class="dropdown-item" href="<?php echo base_url('Backend/Pengaduan/tolak_pengaduan/' . $pengaduan['id_lapor']) ?>"><i class="las la-times-circle scale5 text-danger mr-2"></i>Pengaduan Ditolak</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
